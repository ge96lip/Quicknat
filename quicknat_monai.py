...
class QuickNat(nn.Module):
    """
    Enhanced version of UNet/QuickNat which has residual units implemented with the ResidualUnit class.
    ...
    block rather than afterwards as is typical in UNet/QuickNat implementations.
    ...
    def __init__(
        ...
        def _create_block(
            ...
            """
            Builds the UNet/QuickNat structure from the bottom up by recursing down to the bottom block, then creating sequential
    ...
    def _get_connection_block(self, down_path: nn.Module, up_path: nn.Module, subblock: nn.Module) -> nn.Module:
        """
        Returns the block object defining a layer of the UNet/QuickNat structure including the implementation of the skip
